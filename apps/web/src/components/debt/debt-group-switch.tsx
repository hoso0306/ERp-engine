...
// 2 route riêng (rà soát tab Công nợ, chốt 26/07/2026): /debts/by-order (theo
// đơn hàng) và /debts/by-customer (gộp theo khách hàng, mặc định khi bấm vào
// mục "Công nợ" ở sidebar — /debts chỉ redirect sang đây) — điều hướng thật,
// không phải state ẩn trong 1 trang, nên dùng Link chứ không dùng <Tabs>
// (Tabs điều khiển panel cùng trang, không hợp với chuyển route).
