...
// 8rem: đủ chỗ cho icon + nhãn ngắn khi thu gọn (trước là 3rem, chỉ vừa icon,
// chữ bị overflow-hidden nuốt mất — xem sidebarMenuButtonVariants bên dưới).
...
const sidebarMenuButtonVariants = cva(
  // Bỏ ép size-8!/p-2! khi collapsible=icon — trước đây bó nút thành hình
  // vuông làm mất luôn nhãn chữ. Giờ nút vẫn giữ dạng hàng ngang (icon +
  // chữ), tự co theo --sidebar-width-icon mới rộng hơn (8rem), chữ dài thì
  // truncate qua [&>span:last-child]:truncate thay vì biến mất hẳn.
